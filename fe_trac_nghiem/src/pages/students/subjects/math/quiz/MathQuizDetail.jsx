  ...
  const topics = [
    {
      ...
      link1: "/subjects/math/quiz/numbers/generate?sub=place-value",
      link2: "/subjects/math/quiz/numbers/generate?sub=positive-negative",
      link3: "/subjects/math/quiz/numbers/generate?sub=fractions",
      link4: "/subjects/math/quiz/numbers/generate?sub=number-pattern",
    },
    {
      id: "operations",
      text: "OPERATIONS",
      ...
      link1: "/subjects/math/quiz/operations/generate?sub=addition",
      link2: "/subjects/math/quiz/operations/generate?sub=subtraction",
      link3: "/subjects/math/quiz/operations/generate?sub=multiplication",
      link4: "/subjects/math/quiz/operations/generate?sub=division",
    },
    {
      id: "geometry",
      text: "GEOMETRY",
      ...
      link1: "/subjects/math/quiz/geometry/generate?sub=2d-shapes",
      link2: "/subjects/math/quiz/geometry/generate?sub=3d-shapes",
      link3: "/subjects/math/quiz/geometry/generate?sub=symmetry",
      link4: "/subjects/math/quiz/geometry/generate?sub=angle",
    },
    {
      id: "data",
      text: "HANDLING DATA",
      ...
      link1: "/subjects/math/quiz/data/generate?sub=bar-graph",
      link2: "/subjects/math/quiz/data/generate?sub=venn-diagram",
      link3: "/subjects/math/quiz/data/generate?sub=caroll-diagram",
      link4: "/subjects/math/quiz/data/generate?sub=frequency-table",
    },
    {
      id: "measurement",
      text: "MEASUREMENT",
      ...
      link1: "/subjects/math/quiz/measurement/generate?sub=perimeter",
      link2: "/subjects/math/quiz/measurement/generate?sub=area",
      link3: "/subjects/math/quiz/measurement/generate?sub=length",
      link4: "/subjects/math/quiz/measurement/generate?sub=mass",
    },
    {
      id: "logical",
      ...
      link1: "/subjects/math/quiz/logical/generate?sub=arithmetic",
      link2: "/subjects/math/quiz/logical/generate?sub=geometry",
      link3: "/subjects/math/quiz/logical/generate?sub=number-theory",
      link4: "/subjects/math/quiz/logical/generate?sub=combinatorics",
    },
  ];
